    ...
    return (
        ...
        <Stack spacing={20} sx={{ pt: 10 }}>
                ...
                <Typography component="div">
                    <Box className="body1">
                        ...
                        <Typography sx={{ pt: 5, mx: 10, fontSize: 20, pb: 3}}>We are CashMate, a fintech solution that aims to help farmers/sole proprietors from remote areas </Typography>
                           ...
                           <Box sx={{ display: "flex"}}>
                              <Box sx={{ float: "left", bgcolor: 'success.main', px: 16, fontSize: 20, pt: 5, pb: 5, margin: 1.5}}>
                                <h2>Mission</h2>
                              ...
                              <Box sx={{ float: "right", bgcolor: 'success.main', px: 16, fontSize: 20, pb: 5, pt: 5, margin: 1.5}}>
                                <h2>Vision</h2>
            ...
            <Box>
                <Typography component="div">
                    <Box className="body2">
                        <Typography sx={{ fontWeight: 'bold', m: 1, fontSize: 50, marginTop: -18, marginLeft: 10, pt: 5 }} variant="h3">Our product</Typography>
